...
{                                                                                                  }
{ The Original Code is JclStackTraceViewerMainFormBDS7.pas.                                        }
{                                                                                                  }
...
unit JclStackTraceViewerMainFormBDS7;
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://jcl.svn.sourceforge.net:443/svnroot/jcl/tags/JCL-2.2-Build3970/jcl/experts/stacktraceviewer/JclStackTraceViewerMainFormBDS7.pas $';
