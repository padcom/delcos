{ #(@)$Id: UnitTestGUITesting.pas,v 1.50 2006/07/19 02:52:55 judc Exp $ }
{: DUnit: An XTreme testing framework for Delphi programs.
   @author  The DUnit Group.
   @version $Revision: 1.50 $ uberto 08/03/2001
}
(*
...
const
  rcs_id: string = '#(@)$Id: UnitTestGUITesting.pas,v 1.50 2006/07/19 02:52:55 judc Exp $';
