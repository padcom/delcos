...
const
  ...
  {Stack trace Message}
  CurrentStackTraceMsg = #13#10#13#10'导致该错误的当前堆栈跟踪(调用返回地址): ';
  {Memory dump message}
  ...
  StackTraceAtPrevAllocMsg = #13#10#13#10'该内存块上次被分配时的堆栈跟踪(调用返回地址):';
  StackTraceAtAllocMsg = #13#10#13#10'该内存块本次被分配时的堆栈跟踪(调用返回地址):';
  ...
  StackTraceAtFreeMsg = #13#10#13#10'该内存块上次被释放时的堆栈跟踪(调用返回地址):';
  ...
  StackTraceAtObjectAllocMsg = #13#10#13#10'该对象被分配时的堆栈跟踪(调用返回地址):';
  StackTraceAtObjectFreeMsg = #13#10#13#10'该对象随后被释放时的堆栈跟踪(调用返回地址):';
