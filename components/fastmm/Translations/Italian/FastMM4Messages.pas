...
const
  ...
  StackTraceAtPrevAllocMsg = #13#10#13#10'Trama di stack quando il blocco è stato precedentemente allocato (indirizzi di ritorno):';
  ...
  StackTraceAtFreeMsg = #13#10#13#10'Trama di stack quando il blocco è stato precedentemente deallocato (indirizzi di ritorno):';
  ...
  StackTraceAtObjectAllocMsg = #13#10#13#10'Trama di stack quando l''istanza è stata allocata (indirizzi di ritorno):';
