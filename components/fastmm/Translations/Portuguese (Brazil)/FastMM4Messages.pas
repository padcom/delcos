...
const
  ...
  {Stack trace Message}
  CurrentStackTraceMsg = #13#10#13#10'A pilha atual que leva a esse erro (endereços de retorno): ';
  {Memory dump message}
  ...
  StackTraceAtPrevAllocMsg = #13#10#13#10'Caminho da pilha quando esse bloco foi alocado anteriormente (endereços de retorno):';
  StackTraceAtAllocMsg = #13#10#13#10'Caminho da pilha quando esse bloco foi alocado (endereços de retorno):';
  ...
  StackTraceAtFreeMsg = #13#10#13#10'Caminho da pilha quando o bloco foi liberado anteriormente (endereços de retorno):';
  ...
  StackTraceAtObjectAllocMsg = #13#10#13#10'Caminho da pilha quando o objeto foi alocado (endereços de retorno):';
  StackTraceAtObjectFreeMsg = #13#10#13#10'Caminho da pilha quando o objeto foi liberado (endereços de retorno):';
