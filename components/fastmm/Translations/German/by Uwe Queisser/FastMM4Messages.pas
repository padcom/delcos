...
const
  ...
  CurrentStackTraceMsg = #13#10#13#10'Die aktuelle Stack ablaufverfolgung, die zu diesem Fehler führte (Rückgabeadresse): ';
  ...
  StackTraceAtPrevAllocMsg = #13#10#13#10'Stackverfolgung - Speicherblock wurde bereits zugeordnet (Rückgabeadresse):';
  StackTraceAtAllocMsg = #13#10#13#10'Stackverfolgung - Speicherpuffer wurde zugeordnet (Rückgabeadresse):';
  ...
  StackTraceAtFreeMsg = #13#10#13#10'Stackverfolgung des Speicherpuffers, wann der Speicherblock zuvor freigegeben wurde (Rückgabeadresse):';
  ...
  StackTraceAtObjectAllocMsg = #13#10#13#10'Stackverfolgung des Speicherblocks, wann das Objekt zugeordnet wurde (Rückgabeadresse):';
  StackTraceAtObjectFreeMsg = #13#10#13#10'Stackverfolgung des Speicherpuffers, wann das Objekt anschließend freigegeben wurde (Rückgabeadresse):';
