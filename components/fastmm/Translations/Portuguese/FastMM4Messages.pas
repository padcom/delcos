...
const
  ...
  {Stack trace Message}
  CurrentStackTraceMsg = #13#10#13#10'Registo do Stack actual que leva a esse erro (endereços de retorno): ';
  {Memory dump message}
  ...
  StackTraceAtPrevAllocMsg = #13#10#13#10'Registo do Stack quando esse bloco foi atribuido anteriormente (endereços de retorno):';
  StackTraceAtAllocMsg = #13#10#13#10'Registo do Stack quando esse bloco foi atribuido (endereços de retorno):';
  ...
  StackTraceAtFreeMsg = #13#10#13#10'Registo do Stack quando o bloco foi libertado anteriormente (endereços de retorno):';
  ...
  StackTraceAtObjectAllocMsg = #13#10#13#10'Registo do Stack quando o objecto foi atribuido (endereços de retorno):';
  StackTraceAtObjectFreeMsg = #13#10#13#10'Registo do Stack quando o objecto foi libertado (endereços de retorno):';
